  ...
  const [data] = useState<Statistic[]>([
    {
      ...
      discription: <span className="text-[#FCB859]">+10% from yesterday</span>,
    },
    {
      key: 2,
      ...
      title: <span>Total Order</span>,
      discription: <span className="text-[#A9DFD8]">+8% from yesterday</span>,
    },
    {
      key: 3,
      ...
      number: <span>9</span>,
      title: <span>Total Order</span>,
      discription: <span className="text-[#f2c8ed]">+2% from yesterday</span>,
    },
    {
      key: 4,
      ...
      number: <span>12</span>,
      title: <span>Total Order</span>,
      discription: <span className="text-[#20aef3]">+3% from yesterday</span>,
    },
  ]);
