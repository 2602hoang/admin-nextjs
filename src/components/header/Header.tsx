...
export const Header: React.FC<HeaderProps> = ({
  ...
  const items: MenuProps["items"] = [
    {
      label: (
        <p className="gap-2 text-Light_Gray flex items-center">
          <IconViewProfile />
          <span className="text-Light_Gray"> View Profile</span>
        </p>
      ),
      key: "/profile",
    },
    {
      label: (
        <p className="gap-2 text-Light_Gray flex items-center">
          <IconSettingAccout />
          <span className="text-Light_Gray"> Account Settings</span>
        </p>
      ),
      key: "/setting",
    },
    {
      label: (
        <p className="gap-2 text-Light_Gray  flex items-center">
          <IconNotication />
          <span className="text-Light_Gray"> Notifications</span>
        </p>
      ),
      key: "/notifications",
    },
    {
      label: (
        <a className="gap-2 text-Light_Gray flex items-center">
          <SwitchAccout />
          <span className="text-Light_Gray"> Switch Account</span>
        </a>
      ),
      key: "/switch-account",
    },
    {
      label: (
        <p className="gap-2 text-Light_Gray flex-row flex items-center">
          <IconHelp /> <span className="text-Light_Gray"> Help Center</span>
        </p>
      ),
      key: "/help",
    },
  ...
  return (
    <div className="h-20 md:h-[116px] flex items-center z-50 bg-Brown justify-between transition-all duration-300">
      <div className="flex items-center justify-start gap-2 w-full">
        ...
        <div className="w-full h-[52px]">
          <Input
            className="md:w-[73%] 2xl:w-[71%] h-full gap-x-[3px] rounded-lg pl-1 flex border-none bg-Dark_Slate_Gray text-white focus:border-Light_Gray focus-within:bg-Light_Gray hover:bg-Light_Gray"
      ...
      <div className="flex gap-x-1 md:gap-x-3  items-center justify-center">
        ...
        <div className="flex items-center gap-x-1 md:gap-x-4 pr-9">
          <Avatar
